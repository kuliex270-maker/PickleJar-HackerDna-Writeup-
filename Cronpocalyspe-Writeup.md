...
This writeup outlines the intended exploitation path, the underlying concepts, and the exact commands to compromise the machine, with all flags redacted so you can still claim the points.
